...
PSIMD_INTRINSIC psimd_f32 fp16_ieee_to_fp32_psimd(psimd_u16 half) {
	...
	const psimd_f32 denorm_nonsign = psimd_sub_f32(to_float(psimd_interleave_lo_u16(half + half, magic_mask)), magic_bias);
...
PSIMD_INTRINSIC psimd_f32x2 fp16_ieee_to_fp32x2_psimd(psimd_u16 half) {
	...
	const psimd_f32 magic_bias = psimd_splat_f32(0.25f);
	const psimd_f32 denorm_nonsign_lo = psimd_sub_f32(to_float(psimd_interleave_lo_u16(shl1_half, magic_mask)), magic_bias);
	const psimd_f32 denorm_nonsign_hi = psimd_sub_f32(to_float(psimd_interleave_hi_u16(shl1_half, magic_mask)), magic_bias);
