...
#define CEXP__0PI_OVER_16 std::complex<float>(COS__0PI_OVER_16, SIN__0PI_OVER_16)
#define CEXP__1PI_OVER_16 std::complex<float>(COS__1PI_OVER_16, SIN__1PI_OVER_16)
#define CEXP__2PI_OVER_16 std::complex<float>(COS__2PI_OVER_16, SIN__2PI_OVER_16)
#define CEXP__3PI_OVER_16 std::complex<float>(COS__3PI_OVER_16, SIN__3PI_OVER_16)
#define CEXP__4PI_OVER_16 std::complex<float>(COS__4PI_OVER_16, SIN__4PI_OVER_16)
#define CEXP__5PI_OVER_16 std::complex<float>(COS__5PI_OVER_16, SIN__5PI_OVER_16)
#define CEXP__6PI_OVER_16 std::complex<float>(COS__6PI_OVER_16, SIN__6PI_OVER_16)
#define CEXP__7PI_OVER_16 std::complex<float>(COS__7PI_OVER_16, SIN__7PI_OVER_16)
#define CEXP__8PI_OVER_16 std::complex<float>(COS__8PI_OVER_16, SIN__8PI_OVER_16)
#define CEXP__9PI_OVER_16 std::complex<float>(COS__9PI_OVER_16, SIN__9PI_OVER_16)
#define CEXP_10PI_OVER_16 std::complex<float>(COS_10PI_OVER_16, SIN_10PI_OVER_16)
#define CEXP_11PI_OVER_16 std::complex<float>(COS_11PI_OVER_16, SIN_11PI_OVER_16)
#define CEXP_12PI_OVER_16 std::complex<float>(COS_12PI_OVER_16, SIN_12PI_OVER_16)
#define CEXP_13PI_OVER_16 std::complex<float>(COS_13PI_OVER_16, SIN_13PI_OVER_16)
#define CEXP_14PI_OVER_16 std::complex<float>(COS_14PI_OVER_16, SIN_14PI_OVER_16)
#define CEXP_15PI_OVER_16 std::complex<float>(COS_15PI_OVER_16, SIN_15PI_OVER_16)

#define CEXP_0PI_OVER_8 std::complex<float>(COS_0PI_OVER_8, SIN_0PI_OVER_8)
#define CEXP_1PI_OVER_8 std::complex<float>(COS_1PI_OVER_8, SIN_1PI_OVER_8)
#define CEXP_2PI_OVER_8 std::complex<float>(COS_2PI_OVER_8, SIN_2PI_OVER_8)
#define CEXP_3PI_OVER_8 std::complex<float>(COS_3PI_OVER_8, SIN_3PI_OVER_8)
#define CEXP_4PI_OVER_8 std::complex<float>(COS_4PI_OVER_8, SIN_4PI_OVER_8)
#define CEXP_5PI_OVER_8 std::complex<float>(COS_5PI_OVER_8, SIN_5PI_OVER_8)
#define CEXP_6PI_OVER_8 std::complex<float>(COS_6PI_OVER_8, SIN_6PI_OVER_8)
#define CEXP_7PI_OVER_8 std::complex<float>(COS_7PI_OVER_8, SIN_7PI_OVER_8)

#define CEXP_0PI_OVER_4 std::complex<float>(COS_0PI_OVER_4, SIN_0PI_OVER_4)
#define CEXP_1PI_OVER_4 std::complex<float>(COS_1PI_OVER_4, SIN_1PI_OVER_4)
#define CEXP_2PI_OVER_4 std::complex<float>(COS_2PI_OVER_4, SIN_2PI_OVER_4)
#define CEXP_3PI_OVER_4 std::complex<float>(COS_3PI_OVER_4, SIN_3PI_OVER_4)

#define CEXP_0PI_OVER_2 std::complex<float>(COS_0PI_OVER_2, SIN_0PI_OVER_2)
#define CEXP_1PI_OVER_2 std::complex<float>(COS_1PI_OVER_2, SIN_1PI_OVER_2)
